                    ...
                    children: [
                      Container(
                        ...
                        child: ClipRRect(
                            borderRadius: BorderRadius.circular(12),
                            child: Image.asset(
                                "assets/images/Anas.jpg", fit: BoxFit.cover)),
                      ),
                      SizedBox(width: 4.w,),
                      Column(
                        ...
                        children: [
                          SizedBox(height: 4.h),
                          CustomText(text: "Anas Nabih",
                            fontWeight: FontWeight.w400,
                            fontSize: 18.sp,),
                          CustomText(text: "anas7nabih@gmail.com",
                  ...
                  Expanded(
                    child: ScrollConfiguration(
                      ...
                      child: ListView(
                        ...
                        children: [
                          AccountItem(title: "Edit Profile".tr,),
                          SwitchValAccountItem(title: "Notifications".tr,
                              isNotificationSwitcher: true),
                            SwitchValAccountItem(title: "Dark Mode".tr,
                              hasIcon: true,
                              iconData: controller.isDarkTheme.value ? Icons
                                  .light_mode_outlined : Icons
                                  .dark_mode_outlined),
                          AccountItem(title: "Shipping Address".tr,),
                          AccountItem(title: "Order history".tr,),
                          AccountItem(title: "Cards".tr,),
                          AccountItem(title: "Language".tr, onTapped: () {
                          ...
                          AccountItem(title: "Log Out".tr, isEnd: true,
                              onTapped: () =>
